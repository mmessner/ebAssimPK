...
public class Monitor extends JFrame {
	...
	public void run()
	{
		File f = new File ("log/integracao.log");
		pathArquivo.setText(f.getAbsolutePath());
...
//		this.setTitle("Integrador SAP-NFe - Filial " + ConfigUtil.getProperty("company"));
	}
